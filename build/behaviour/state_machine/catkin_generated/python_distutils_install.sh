...
echo_and_run cd "/robotica_ufu/src/behaviour/state_machine"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/robotica_ufu/src/behaviour/state_machine/setup.py" \
     \
    build --build-base "/robotica_ufu/build/behaviour/state_machine" \
    install \
    --root="${DESTDIR-/}" \
