...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/robotica_ufu/src/movement/humanoid_interface/include".split(';') if "/robotica_ufu/src/movement/humanoid_interface/include" != "" else []
