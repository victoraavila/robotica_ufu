...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __default__.curve = 1;
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(HumanoidLipWalkingParamsConfig::AbstractParamDescriptionConstPtr(new HumanoidLipWalkingParamsConfig::ParamDescription<int>("curve", "int", 0, "The type of curve", "{'enum': [{'name': 'SIN', 'type': 'int', 'value': 0, 'srcline': 17, 'srcfile': '/robotica_ufu/src/movement/movement_msgs/cfg/HumanoidLipWalkingParams.cfg', 'description': 'SIN CURVE', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'SIN_2', 'type': 'int', 'value': 1, 'srcline': 18, 'srcfile': '/robotica_ufu/src/movement/movement_msgs/cfg/HumanoidLipWalkingParams.cfg', 'description': 'SIN SQUARED CURVE', 'ctype': 'int', 'cconsttype': 'const int'}, {'name': 'CUSTOM', 'type': 'int', 'value': 2, 'srcline': 19, 'srcfile': '/robotica_ufu/src/movement/movement_msgs/cfg/HumanoidLipWalkingParams.cfg', 'description': 'CUSTOM CURVE', 'ctype': 'int', 'cconsttype': 'const int'}], 'enum_description': 'CURVE TYPE'}", &HumanoidLipWalkingParamsConfig::curve)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 17 "/robotica_ufu/src/movement/movement_msgs/cfg/HumanoidLipWalkingParams.cfg"
      const int HumanoidLipWalkingParams_SIN = 0;
//#line 18 "/robotica_ufu/src/movement/movement_msgs/cfg/HumanoidLipWalkingParams.cfg"
      const int HumanoidLipWalkingParams_SIN_2 = 1;
//#line 19 "/robotica_ufu/src/movement/movement_msgs/cfg/HumanoidLipWalkingParams.cfg"
