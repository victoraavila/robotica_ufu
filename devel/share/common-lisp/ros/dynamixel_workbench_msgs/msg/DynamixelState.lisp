...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DynamixelState>)))
  ...
  "94ee1efa4bed8b620501e045f04bbb00")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DynamixelState)))
  "Returns md5sum for a message object of type 'DynamixelState"
  "94ee1efa4bed8b620501e045f04bbb00")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DynamixelState>)))
  ...
  (cl:format cl:nil "# This message includes basic data of dynamixel~%~%string model_name~%uint8  id~%uint8  torque_enable~%~%int16  goal_current~%int32  goal_velocity~%uint32 goal_position~%~%int16  present_current~%int32  present_velocity~%uint32 present_position~%~%uint8 moving~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DynamixelState)))
  "Returns full string definition for message of type 'DynamixelState"
  (cl:format cl:nil "# This message includes basic data of dynamixel~%~%string model_name~%uint8  id~%uint8  torque_enable~%~%int16  goal_current~%int32  goal_velocity~%uint32 goal_position~%~%int16  present_current~%int32  present_velocity~%uint32 present_position~%~%uint8 moving~%~%~%~%"))
