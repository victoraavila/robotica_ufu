...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DynamixelStateList>)))
  ...
  "b9042c3ec8868f2c7b597679f24273e4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DynamixelStateList)))
  "Returns md5sum for a message object of type 'DynamixelStateList"
  "b9042c3ec8868f2c7b597679f24273e4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DynamixelStateList>)))
  ...
  (cl:format cl:nil "# DynamixelState List~%~%DynamixelState[] dynamixel_state~%~%================================================================================~%MSG: dynamixel_workbench_msgs/DynamixelState~%# This message includes basic data of dynamixel~%~%string model_name~%uint8  id~%uint8  torque_enable~%~%int16  goal_current~%int32  goal_velocity~%uint32 goal_position~%~%int16  present_current~%int32  present_velocity~%uint32 present_position~%~%uint8 moving~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DynamixelStateList)))
  "Returns full string definition for message of type 'DynamixelStateList"
  (cl:format cl:nil "# DynamixelState List~%~%DynamixelState[] dynamixel_state~%~%================================================================================~%MSG: dynamixel_workbench_msgs/DynamixelState~%# This message includes basic data of dynamixel~%~%string model_name~%uint8  id~%uint8  torque_enable~%~%int16  goal_current~%int32  goal_velocity~%uint32 goal_position~%~%int16  present_current~%int32  present_velocity~%uint32 present_position~%~%uint8 moving~%~%~%~%"))
