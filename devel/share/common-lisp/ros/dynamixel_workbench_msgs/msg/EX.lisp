...
(cl:defclass <EX> (roslisp-msg-protocol:ros-message)
  ((model_number
    :reader model_number
...
(cl:defmethod cl:initialize-instance :after ((m <EX>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'EX)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dynamixel_workbench_msgs-msg:<EX> is deprecated: use dynamixel_workbench_msgs-msg:EX instead.")))

(cl:ensure-generic-function 'model_number-val :lambda-list '(m))
(cl:defmethod model_number-val ((m <EX>))
...
(cl:defmethod version_of_firmware-val ((m <EX>))
...
(cl:defmethod baud_rate-val ((m <EX>))
...
(cl:defmethod return_delay_time-val ((m <EX>))
...
(cl:defmethod cw_angle_limit-val ((m <EX>))
...
(cl:defmethod ccw_angle_limit-val ((m <EX>))
...
(cl:defmethod drive_mode-val ((m <EX>))
...
(cl:defmethod the_highest_limit_temperature-val ((m <EX>))
...
(cl:defmethod the_lowest_limit_voltage-val ((m <EX>))
...
(cl:defmethod the_highest_limit_voltage-val ((m <EX>))
...
(cl:defmethod max_torque-val ((m <EX>))
...
(cl:defmethod status_return_level-val ((m <EX>))
...
(cl:defmethod alarm_led-val ((m <EX>))
...
(cl:defmethod alarm_shutdown-val ((m <EX>))
...
(cl:defmethod torque_enable-val ((m <EX>))
...
(cl:defmethod cw_compliance_margin-val ((m <EX>))
...
(cl:defmethod ccw_compliance_margin-val ((m <EX>))
...
(cl:defmethod cw_compliance_slope-val ((m <EX>))
...
(cl:defmethod ccw_compliance_slope-val ((m <EX>))
...
(cl:defmethod goal_position-val ((m <EX>))
...
(cl:defmethod moving_speed-val ((m <EX>))
...
(cl:defmethod torque_limit-val ((m <EX>))
...
(cl:defmethod present_position-val ((m <EX>))
...
(cl:defmethod present_velocity-val ((m <EX>))
...
(cl:defmethod present_load-val ((m <EX>))
...
(cl:defmethod present_voltage-val ((m <EX>))
...
(cl:defmethod present_temperature-val ((m <EX>))
...
(cl:defmethod registered-val ((m <EX>))
...
(cl:defmethod sensed_current-val ((m <EX>))
  ...
  (sensed_current m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EX>) ostream)
  ...
  (cl:write-byte (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'sensed_current)) ostream)
  (cl:write-byte (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'sensed_current)) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EX>) istream)
  "Deserializes a message object of type '<EX>"
    ...
    (cl:setf (cl:ldb (cl:byte 8 0) (cl:slot-value msg 'sensed_current)) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 8) (cl:slot-value msg 'sensed_current)) (cl:read-byte istream))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EX>)))
  "Returns string type for a message object of type '<EX>"
  "dynamixel_workbench_msgs/EX")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EX)))
  "Returns string type for a message object of type 'EX"
  "dynamixel_workbench_msgs/EX")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EX>)))
  "Returns md5sum for a message object of type '<EX>"
  "1dfd37dc40b212e3cd37bed2f185264b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EX)))
  "Returns md5sum for a message object of type 'EX"
  "1dfd37dc40b212e3cd37bed2f185264b")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EX>)))
  "Returns full string definition for message of type '<EX>"
  (cl:format cl:nil "# It is Published by 'single_dynamixel_monitor' node~%# It is Subscribed by 'dynamixel_workbench_single_manager_gui/qnode' node~%# This message is compatible with control table of Dynamixel EX Series (EX-106+)~%# It is linked to 'EX_106.device' in dynamixel_workbench_toolbox/dynamixel/models/EX~%# If you want to specific information about control table, please follow the link (http://support.robotis.com/en/)~%~%uint16 model_number~%uint8 version_of_firmware~%uint8 id~%uint8 baud_rate~%uint8 return_delay_time~%uint16 cw_angle_limit~%uint16 ccw_angle_limit~%uint8 drive_mode~%uint8 the_highest_limit_temperature~%uint8 the_lowest_limit_voltage~%uint8 the_highest_limit_voltage~%uint16 max_torque~%uint8 status_return_level~%uint8 alarm_led~%uint8 alarm_shutdown~%~%uint8 torque_enable~%uint8 led~%uint8 cw_compliance_margin~%uint8 ccw_compliance_margin~%uint8 cw_compliance_slope~%uint8 ccw_compliance_slope~%uint16 goal_position~%uint16 moving_speed~%uint16 torque_limit~%uint16 present_position~%uint16 present_velocity~%uint16 present_load~%uint8 present_voltage~%uint8 present_temperature~%uint8 registered~%uint8 moving~%uint8 lock~%uint16 punch~%uint16 sensed_current~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EX)))
  "Returns full string definition for message of type 'EX"
  (cl:format cl:nil "# It is Published by 'single_dynamixel_monitor' node~%# It is Subscribed by 'dynamixel_workbench_single_manager_gui/qnode' node~%# This message is compatible with control table of Dynamixel EX Series (EX-106+)~%# It is linked to 'EX_106.device' in dynamixel_workbench_toolbox/dynamixel/models/EX~%# If you want to specific information about control table, please follow the link (http://support.robotis.com/en/)~%~%uint16 model_number~%uint8 version_of_firmware~%uint8 id~%uint8 baud_rate~%uint8 return_delay_time~%uint16 cw_angle_limit~%uint16 ccw_angle_limit~%uint8 drive_mode~%uint8 the_highest_limit_temperature~%uint8 the_lowest_limit_voltage~%uint8 the_highest_limit_voltage~%uint16 max_torque~%uint8 status_return_level~%uint8 alarm_led~%uint8 alarm_shutdown~%~%uint8 torque_enable~%uint8 led~%uint8 cw_compliance_margin~%uint8 ccw_compliance_margin~%uint8 cw_compliance_slope~%uint8 ccw_compliance_slope~%uint16 goal_position~%uint16 moving_speed~%uint16 torque_limit~%uint16 present_position~%uint16 present_velocity~%uint16 present_load~%uint8 present_voltage~%uint8 present_temperature~%uint8 registered~%uint8 moving~%uint8 lock~%uint16 punch~%uint16 sensed_current~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <EX>))
  (cl:+ 0
     2
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EX>))
