...
(cl:in-package phidgets_high_speed_encoder-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <EncoderDecimatedSpeed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EncoderDecimatedSpeed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name phidgets_high_speed_encoder-msg:<EncoderDecimatedSpeed> is deprecated: use phidgets_high_speed_encoder-msg:EncoderDecimatedSpeed instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <EncoderDecimatedSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader phidgets_high_speed_encoder-msg:header-val is deprecated.  Use phidgets_high_speed_encoder-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'avr_speed-val :lambda-list '(m))
(cl:defmethod avr_speed-val ((m <EncoderDecimatedSpeed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader phidgets_high_speed_encoder-msg:avr_speed-val is deprecated.  Use phidgets_high_speed_encoder-msg:avr_speed instead.")
  (avr_speed m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EncoderDecimatedSpeed>)))
  ...
  "phidgets_high_speed_encoder/EncoderDecimatedSpeed")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EncoderDecimatedSpeed)))
  "Returns string type for a message object of type 'EncoderDecimatedSpeed"
  "phidgets_high_speed_encoder/EncoderDecimatedSpeed")
