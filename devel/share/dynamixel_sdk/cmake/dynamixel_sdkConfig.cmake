...
if("TRUE" STREQUAL "TRUE")
  set(dynamixel_sdk_SOURCE_PREFIX /robotica_ufu/src/movement/3rdparty/dynamixel_c++)
  set(dynamixel_sdk_DEVEL_PREFIX /robotica_ufu/devel)
  ...
  set(dynamixel_sdk_INSTALL_PREFIX /robotica_ufu/install)
...
if(NOT "/robotica_ufu/src/movement/3rdparty/dynamixel_c++/include " STREQUAL " ")
  set(dynamixel_sdk_INCLUDE_DIRS "")
  set(_include_dirs "/robotica_ufu/src/movement/3rdparty/dynamixel_c++/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/robotica_ufu/src/movement/3rdparty/dynamixel_c++/${idir}'.  ${_report}")
    endif()
