...
if("TRUE" STREQUAL "TRUE")
  set(dynamixel_workbench_toolbox_SOURCE_PREFIX /robotica_ufu/src/movement/3rdparty/dynamixel-workbench/dynamixel_workbench_toolbox)
  set(dynamixel_workbench_toolbox_DEVEL_PREFIX /robotica_ufu/devel)
  ...
  set(dynamixel_workbench_toolbox_INSTALL_PREFIX /robotica_ufu/install)
...
if(NOT "/robotica_ufu/src/movement/3rdparty/dynamixel-workbench/dynamixel_workbench_toolbox/include " STREQUAL " ")
  set(dynamixel_workbench_toolbox_INCLUDE_DIRS "")
  set(_include_dirs "/robotica_ufu/src/movement/3rdparty/dynamixel-workbench/dynamixel_workbench_toolbox/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_workbench_toolbox' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/robotica_ufu/src/movement/3rdparty/dynamixel-workbench/dynamixel_workbench_toolbox/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;roslib;dynamixel_sdk")
