...
class XL {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int16(obj.present_load, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.present_load = _deserializer.int16(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'e8e1a2c36244b1ea3db9410aa21f5938';
  }
