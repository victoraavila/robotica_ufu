...
if("TRUE" STREQUAL "TRUE")
  set(imu_filter_madgwick_SOURCE_PREFIX /robotica_ufu/src/movement/3rdparty/imu_tools/imu_filter_madgwick)
  set(imu_filter_madgwick_DEVEL_PREFIX /robotica_ufu/devel)
  ...
  set(imu_filter_madgwick_INSTALL_PREFIX /robotica_ufu/install)
...
if(NOT "/robotica_ufu/devel/include;/usr/include " STREQUAL " ")
  set(imu_filter_madgwick_INCLUDE_DIRS "")
  set(_include_dirs "/robotica_ufu/devel/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_filter_madgwick' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/robotica_ufu/src/movement/3rdparty/imu_tools/imu_filter_madgwick/${idir}'.  ${_report}")
    endif()
