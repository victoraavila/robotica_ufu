...
if("TRUE" STREQUAL "TRUE")
  set(phidgets_high_speed_encoder_SOURCE_PREFIX /robotica_ufu/src/movement/3rdparty/phidgets_drivers/phidgets_high_speed_encoder)
  set(phidgets_high_speed_encoder_DEVEL_PREFIX /robotica_ufu/devel)
  ...
  set(phidgets_high_speed_encoder_INSTALL_PREFIX /robotica_ufu/install)
...
if(NOT "/robotica_ufu/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phidgets_high_speed_encoder' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/robotica_ufu/src/movement/3rdparty/phidgets_drivers/phidgets_high_speed_encoder/${idir}'.  ${_report}")
    endif()
