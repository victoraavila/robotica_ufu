...
if("TRUE" STREQUAL "TRUE")
  set(state_machine_SOURCE_PREFIX /robotica_ufu/src/behaviour/state_machine)
  set(state_machine_DEVEL_PREFIX /robotica_ufu/devel)
  ...
  set(state_machine_INSTALL_PREFIX /robotica_ufu/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'hericles <hericlesferraz@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'state_machine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/robotica_ufu/src/behaviour/state_machine/${idir}'.  ${_report}")
    endif()
